...
public final  class countrycitywc_impl extends GXWebComponent
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.kbbaru.countrycitywc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV6CountryId,4,0))}, new String[] {"CountryId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV6CountryId", GXutil.ltrim( localUtil.ntoc( wcpOAV6CountryId, (byte)(4), (byte)(0), ".", "")));
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vCOUNTRYID", GXutil.ltrim( localUtil.ntoc( AV6CountryId, (byte)(4), (byte)(0), ".", "")));
   ...
   public void wb1I0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.kbbaru.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.kbbaru.countrycitywc");
         }
         /* Div Control */
   ...
   public void rf1I2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H001I2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV6CountryId), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_15_idx = 1 ;
         sGXsfl_15_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_15_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_152( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A5CountryId = H001I2_A5CountryId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A5CountryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A5CountryId), 4, 0));
            A16CountryCityName = H001I2_A16CountryCityName[0] ;
            A12CountryCityId = H001I2_A12CountryCityId[0] ;
            e121I2 ();
   ...
   {
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6CountryId_PARM", GXutil.ltrim( localUtil.ntoc( AV6CountryId, (byte)(4), (byte)(0), ".", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV6CountryId)) > 0 )
      {
         com.kbbaru.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6CountryId_CTRL", GXutil.rtrim( sCtrlAV6CountryId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202352315529", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("countrycitywc.js", "?202352315529", false, true);
      }
   ...
   {
      edtCountryCityId_Internalname = sPrefix+"COUNTRYCITYID_"+sGXsfl_15_idx ;
      edtCountryCityName_Internalname = sPrefix+"COUNTRYCITYNAME_"+sGXsfl_15_idx ;
   }

   public void subsflControlProps_fel_152( )
   {
      edtCountryCityId_Internalname = sPrefix+"COUNTRYCITYID_"+sGXsfl_15_fel_idx ;
      edtCountryCityName_Internalname = sPrefix+"COUNTRYCITYNAME_"+sGXsfl_15_fel_idx ;
   }
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e121I2',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      AV15Pgmname = "" ;
      scmdbuf = "" ;
      H001I2_A5CountryId = new short[1] ;
      H001I2_A16CountryCityName = new String[] {""} ;
      H001I2_A12CountryCityId = new short[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.kbbaru.countrycitywc__default(),
         new Object[] {
             new Object[] {
            H001I2_A5CountryId, H001I2_A16CountryCityName, H001I2_A12CountryCityId
            }
            , new Object[] {
   ...
   private short[] H001I2_A5CountryId ;
   private String[] H001I2_A16CountryCityName ;
   private short[] H001I2_A12CountryCityId ;
...
final  class countrycitywc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H001I2", "SELECT CountryId, CountryCityName, CountryCityId FROM CountryCity WHERE CountryId = ? ORDER BY CountryId  OFFSET ? LIMIT CASE WHEN ? > 0 THEN ? ELSE 1e9 END",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H001I3", "SELECT COUNT(*) FROM CountryCity WHERE CountryId = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
