...
public final  class gx00g1_impl extends GXDataArea
{
   public gx00g1_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gx00g1_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gx00g1_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV9pAttractionsId = (short)(GXutil.lval( httpContext.GetPar( "pAttractionsId"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9pAttractionsId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9pAttractionsId), 4, 0));
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void gxgrgrid1_refresh_invoke( )
   {
      ...
      AV8pTripsId = (short)(GXutil.lval( httpContext.GetPar( "pTripsId"))) ;
      httpContext.setAjaxCallMode();
      if ( ! httpContext.IsValidAjaxCall( true) )
      {
         GxWebError = (byte)(1) ;
      ...
      gxgrgrid1_refresh( subGrid1_Rows, AV6cAttractionsId, AV8pTripsId) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.kbbaru.gx00g1", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8pTripsId,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9pAttractionsId,4,0))}, new String[] {"pTripsId","pAttractionsId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "vPATTRACTIONSID", GXutil.ltrim( localUtil.ntoc( AV9pAttractionsId, (byte)(4), (byte)(0), ".", "")));
   ...
   {
      return formatLink("com.kbbaru.gx00g1", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8pTripsId,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9pAttractionsId,4,0))}, new String[] {"pTripsId","pAttractionsId"})  ;
   }
   ...
   public void wb230( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kbbaru.GxWebStd.gx_label_ctrl( httpContext, lblLblattractionsidfilter_Internalname, "Attractions Id", "", "", lblLblattractionsidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11231_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx00G1.htm");
         ...
         com.kbbaru.GxWebStd.gx_single_line_edit( httpContext, edtavCattractionsid_Internalname, GXutil.ltrim( localUtil.ntoc( AV6cAttractionsId, (byte)(4), (byte)(0), ".", "")), GXutil.ltrim( ((edtavCattractionsid_Enabled!=0) ? localUtil.format( DecimalUtil.doubleToDec(AV6cAttractionsId), "ZZZ9") : localUtil.format( DecimalUtil.doubleToDec(AV6cAttractionsId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCattractionsid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCattractionsid_Visible, edtavCattractionsid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_Gx00G1.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.kbbaru.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 24, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e12231_client"+"'", TempTags, "", 2, "HLP_Gx00G1.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 24 )
      {
         ...
         StyleString = "" ;
         com.kbbaru.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 24, 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx00G1.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start232( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selection List Attrations", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf232( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H00232 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8pTripsId), Short.valueOf(AV6cAttractionsId), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_24_idx = 1 ;
         sGXsfl_24_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_24_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_242( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subgrid1_fnc_recordsperpage( ) ) ) )
         {
            A25TripsId = H00232_A25TripsId[0] ;
            A9AttractionsId = H00232_A9AttractionsId[0] ;
            /* Execute user event: Load */
            e14232 ();
   ...
   {
      /* Using cursor H00233 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8pTripsId), Short.valueOf(AV6cAttractionsId)});
   ...
   public void e13232( )
   {
      /* Start Routine */
      returnInSub = false ;
      Form.setCaption( GXutil.format( "Selection List %1", "Attrations", "", "", "", "", "", "", "", "") );
   ...
   public void e15232( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV9pAttractionsId = A9AttractionsId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9pAttractionsId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9pAttractionsId), 4, 0));
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV9pAttractionsId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV9pAttractionsId"});
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV8pTripsId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8pTripsId), 4, 0));
      AV9pAttractionsId = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9pAttractionsId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9pAttractionsId), 4, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20235231553652", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx00g1.js", "?20235231553652", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtTripsId_Internalname = "TRIPSID_"+sGXsfl_24_idx ;
   }
   ...
   public void subsflControlProps_fel_242( )
   {
      ...
      edtTripsId_Internalname = "TRIPSID_"+sGXsfl_24_fel_idx ;
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid1_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         edtAttractionsId_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A9AttractionsId, (byte)(4), (byte)(0), ".", "")))+"'"+"]);" ;
         httpContext.ajax_rsp_assign_prop("", false, edtAttractionsId_Internalname, "Link", edtAttractionsId_Link, !bGXsfl_24_Refreshing);
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtAttractionsId_Internalname,GXutil.ltrim( localUtil.ntoc( A9AttractionsId, (byte)(4), (byte)(0), ".", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A9AttractionsId), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'",edtAttractionsId_Link,"","","",edtAttractionsId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(24),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( Grid1Container.GetWrapped() == 1 )
         {
   ...
   public void startgridcontrol24( )
   {
      if ( Grid1Container.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( "Trips Id") ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         Grid1Column.AddObjectProperty("Link", GXutil.rtrim( edtAttractionsId_Link));
         Grid1Container.AddColumnProperties(Grid1Column);
         Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Selection List Attrations" );
      subGrid1_Rows = 10 ;
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionsId',fld:'vCATTRACTIONSID',pic:'ZZZ9'},{av:'AV8pTripsId',fld:'vPTRIPSID',pic:'ZZZ9'}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("'TOGGLE'","{handler:'e12231',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
      setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLATTRACTIONSIDFILTER.CLICK","{handler:'e11231',iparms:[{av:'divAttractionsidfiltercontainer_Class',ctrl:'ATTRACTIONSIDFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("ENTER","{handler:'e15232',iparms:[{av:'A9AttractionsId',fld:'ATTRACTIONSID',pic:'ZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV9pAttractionsId',fld:'vPATTRACTIONSID',pic:'ZZZ9'}]}");
      setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionsId',fld:'vCATTRACTIONSID',pic:'ZZZ9'},{av:'AV8pTripsId',fld:'vPTRIPSID',pic:'ZZZ9'}]");
      setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
      setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionsId',fld:'vCATTRACTIONSID',pic:'ZZZ9'},{av:'AV8pTripsId',fld:'vPTRIPSID',pic:'ZZZ9'}]");
      setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
      setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionsId',fld:'vCATTRACTIONSID',pic:'ZZZ9'},{av:'AV8pTripsId',fld:'vPTRIPSID',pic:'ZZZ9'}]");
      setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
      setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionsId',fld:'vCATTRACTIONSID',pic:'ZZZ9'},{av:'AV8pTripsId',fld:'vPTRIPSID',pic:'ZZZ9'}]");
      setEventMetadata("GRID1_LASTPAGE",",oparms:[]}");
      setEventMetadata("NULL","{handler:'valid_Tripsid',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00232_A25TripsId = new short[1] ;
      H00232_A9AttractionsId = new short[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.kbbaru.gx00g1__default(),
         new Object[] {
             new Object[] {
            H00232_A25TripsId, H00232_A9AttractionsId
            }
            , new Object[] {
   ...
   private short wcpOAV8pTripsId ;
   private short AV8pTripsId ;
   private short AV9pAttractionsId ;
   ...
   private String edtAttractionsId_Link ;
   ...
   private short[] H00232_A25TripsId ;
   private short[] H00232_A9AttractionsId ;
   private long[] H00233_AGRID1_nRecordCount ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class gx00g1__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00232", "SELECT TripsId, AttractionsId FROM TripsAttrations WHERE TripsId = ? and AttractionsId >= ? ORDER BY TripsId, AttractionsId  OFFSET ? LIMIT CASE WHEN ? > 0 THEN ? ELSE 1e9 END",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00233", "SELECT COUNT(*) FROM TripsAttrations WHERE TripsId = ? and AttractionsId >= ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
