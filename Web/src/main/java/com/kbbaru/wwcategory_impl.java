...
public final  class wwcategory_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.kbbaru.wwcategory", new String[] {}, new String[] {}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "GXH_vCATEGORYNAME", AV11CategoryName);
      /* Send saved values. */
      send_integrity_footer_hashes( ) ;
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_27", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_27, (byte)(8), (byte)(0), ".", "")));
   ...
   {
      return formatLink("com.kbbaru.wwcategory", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb1O0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.kbbaru.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Categories", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, (short)(0), "HLP_WWCategory.htm");
         ...
         StyleString = "" ;
         com.kbbaru.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 27, 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWCategory.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.kbbaru.GxWebStd.gx_label_element( httpContext, edtavCategoryname_Internalname, "Category Name", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"" ;
         com.kbbaru.GxWebStd.gx_single_line_edit( httpContext, edtavCategoryname_Internalname, AV11CategoryName, GXutil.rtrim( localUtil.format( AV11CategoryName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavCategoryname_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavCategoryname_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_WWCategory.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void initialize_formulas( )
   {
      ...
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Enabled", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtavUpdate_Enabled), 5, 0), !bGXsfl_27_Refreshing);
      edtavDelete_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Enabled", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtavDelete_Enabled), 5, 0), !bGXsfl_27_Refreshing);
   }
   ...
   public void rf1O2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV11CategoryName = GXutil.concat( GXutil.rtrim( AV11CategoryName), "%", "") ;
         /* Using cursor H001O2 */
         pr_default.execute(0, new Object[] {lV11CategoryName, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_27_idx = 1 ;
         sGXsfl_27_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_27_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_272( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A4CategoryName = H001O2_A4CategoryName[0] ;
            A3CategoryId = H001O2_A3CategoryId[0] ;
            e141O2 ();
   ...
   {
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "gxhash_CATEGORYID"+"_"+sGXsfl_27_idx, getSecureSignedToken( sGXsfl_27_idx, localUtil.format( DecimalUtil.doubleToDec(A3CategoryId), "ZZZ9")));
   }
   ...
   private void e141O2( )
   {
      /* Grid_Load Routine */
      returnInSub = false ;
      edtavUpdate_Link = formatLink("com.kbbaru.category", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A3CategoryId,4,0))}, new String[] {"Mode","CategoryId"})  ;
      edtavDelete_Link = formatLink("com.kbbaru.category", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A3CategoryId,4,0))}, new String[] {"Mode","CategoryId"})  ;
   ...
   public void e111O2( )
   {
      /* 'DoInsert' Routine */
      returnInSub = false ;
      callWebObject(formatLink("com.kbbaru.category", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","CategoryId"}) );
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202352610413720", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("wwcategory.js", "?202352610413720", false, true);
      }
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e141O2',iparms:[{av:'A3CategoryId',fld:'CATEGORYID',pic:'ZZZ9',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e111O2',iparms:[{av:'A3CategoryId',fld:'CATEGORYID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV11CategoryName = "" ;
      H001O2_A4CategoryName = new String[] {""} ;
      H001O2_A3CategoryId = new short[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.kbbaru.wwcategory__default(),
         new Object[] {
             new Object[] {
            H001O2_A4CategoryName, H001O2_A3CategoryId
            }
            , new Object[] {
   ...
   private String[] H001O2_A4CategoryName ;
   private short[] H001O2_A3CategoryId ;
...
final  class wwcategory__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          String A4CategoryName )
   {
      ...
      sOrderString += " ORDER BY CategoryName, CategoryId" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H001O2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
            case 1 :
                  return conditional_H001O3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
      }
