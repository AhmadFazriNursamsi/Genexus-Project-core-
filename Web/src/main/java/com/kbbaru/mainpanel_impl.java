...
public final  class mainpanel_impl extends GXDataArea
{
   public mainpanel_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public mainpanel_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( mainpanel_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.kbbaru.mainpanel", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.kbbaru.mainpanel", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb070( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.kbbaru.GxWebStd.gx_label_ctrl( httpContext, lblTextblock1_Internalname, "Text Block", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_MainPanel.htm");
   ...
   public void start072( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Main Panel", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20235231551771", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("mainpanel.js", "?20235231551771", false, true);
      }
