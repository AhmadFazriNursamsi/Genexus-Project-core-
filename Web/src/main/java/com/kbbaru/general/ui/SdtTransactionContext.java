...
public final  class SdtTransactionContext extends GxUserType
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "Attributes") )
            {
               ...
               {
                  gxTv_SdtTransactionContext_Attributes = new GXBaseCollection<com.kbbaru.general.ui.SdtTransactionContext_Attribute>(com.kbbaru.general.ui.SdtTransactionContext_Attribute.class, "TransactionContext.Attribute", "KBBaru", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("CallerObject", gxTv_SdtTransactionContext_Callerobject);
      if ( GXutil.strcmp(sNameSpace, "KBBaru") != 0 )
      {
         oWriter.writeAttribute("xmlns", "KBBaru");
      }
      oWriter.writeElement("CallerOnDelete", GXutil.booltostr( gxTv_SdtTransactionContext_Callerondelete));
      if ( GXutil.strcmp(sNameSpace, "KBBaru") != 0 )
      {
         oWriter.writeAttribute("xmlns", "KBBaru");
      }
      oWriter.writeElement("CallerURL", gxTv_SdtTransactionContext_Callerurl);
      if ( GXutil.strcmp(sNameSpace, "KBBaru") != 0 )
      {
         oWriter.writeAttribute("xmlns", "KBBaru");
      }
      oWriter.writeElement("TransactionName", gxTv_SdtTransactionContext_Transactionname);
      if ( GXutil.strcmp(sNameSpace, "KBBaru") != 0 )
      {
         oWriter.writeAttribute("xmlns", "KBBaru");
      }
   ...
   public GXBaseCollection<com.kbbaru.general.ui.SdtTransactionContext_Attribute> getgxTv_SdtTransactionContext_Attributes( )
   {
      if ( gxTv_SdtTransactionContext_Attributes == null )
      {
         gxTv_SdtTransactionContext_Attributes = new GXBaseCollection<com.kbbaru.general.ui.SdtTransactionContext_Attribute>(com.kbbaru.general.ui.SdtTransactionContext_Attribute.class, "TransactionContext.Attribute", "KBBaru", remoteHandle);
   ...
   public void setgxTv_SdtTransactionContext_Attributes( GXBaseCollection<com.kbbaru.general.ui.SdtTransactionContext_Attribute> value )
   {
      gxTv_SdtTransactionContext_Attributes_N = (byte)(0) ;
      gxTv_SdtTransactionContext_N = (byte)(0) ;
   ...
   public com.kbbaru.general.ui.SdtTransactionContext Clone( )
   {
      return (com.kbbaru.general.ui.SdtTransactionContext)(clone()) ;
   }

   public void setStruct( com.kbbaru.general.ui.StructSdtTransactionContext struct )
   {
      if ( struct != null )
      {
         ...
         GXBaseCollection<com.kbbaru.general.ui.SdtTransactionContext_Attribute> gxTv_SdtTransactionContext_Attributes_aux = new GXBaseCollection<com.kbbaru.general.ui.SdtTransactionContext_Attribute>(com.kbbaru.general.ui.SdtTransactionContext_Attribute.class, "TransactionContext.Attribute", "KBBaru", remoteHandle);
         Vector<com.kbbaru.general.ui.StructSdtTransactionContext_Attribute> gxTv_SdtTransactionContext_Attributes_aux1 = struct.getAttributes();
         if (gxTv_SdtTransactionContext_Attributes_aux1 != null)
         {
            for (int i = 0; i < gxTv_SdtTransactionContext_Attributes_aux1.size(); i++)
            {
               gxTv_SdtTransactionContext_Attributes_aux.add(new com.kbbaru.general.ui.SdtTransactionContext_Attribute(gxTv_SdtTransactionContext_Attributes_aux1.elementAt(i)));
            }
         }
   ...
   public com.kbbaru.general.ui.StructSdtTransactionContext getStruct( )
   {
      com.kbbaru.general.ui.StructSdtTransactionContext struct = new com.kbbaru.general.ui.StructSdtTransactionContext ();
   ...
   protected GXBaseCollection<com.kbbaru.general.ui.SdtTransactionContext_Attribute> gxTv_SdtTransactionContext_Attributes_aux ;
   protected GXBaseCollection<com.kbbaru.general.ui.SdtTransactionContext_Attribute> gxTv_SdtTransactionContext_Attributes=null ;
}
