...
public final  class SdtTransactionContext_Attribute extends GxUserType
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("AttributeName", gxTv_SdtTransactionContext_Attribute_Attributename);
      if ( GXutil.strcmp(sNameSpace, "KBBaru") != 0 )
      {
         oWriter.writeAttribute("xmlns", "KBBaru");
      }
      oWriter.writeElement("AttributeValue", gxTv_SdtTransactionContext_Attribute_Attributevalue);
      if ( GXutil.strcmp(sNameSpace, "KBBaru") != 0 )
      {
         oWriter.writeAttribute("xmlns", "KBBaru");
      }
   ...
   public com.kbbaru.general.ui.SdtTransactionContext_Attribute Clone( )
   {
      return (com.kbbaru.general.ui.SdtTransactionContext_Attribute)(clone()) ;
   }

   public void setStruct( com.kbbaru.general.ui.StructSdtTransactionContext_Attribute struct )
   {
      if ( struct != null )
      {
   ...
   public com.kbbaru.general.ui.StructSdtTransactionContext_Attribute getStruct( )
   {
      com.kbbaru.general.ui.StructSdtTransactionContext_Attribute struct = new com.kbbaru.general.ui.StructSdtTransactionContext_Attribute ();
