...
public final  class masterunanimosidebar_impl extends GXMasterPage
{
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "vTARGET_MPAGE", AV6target);
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "SIDEBARMENU_MPAGE_Title", GXutil.rtrim( Sidebarmenu_Title));
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "SIDEBARMENU_MPAGE_Distancetotop", GXutil.ltrim( localUtil.ntoc( Sidebarmenu_Distancetotop, (byte)(9), (byte)(0), ".", "")));
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "SIDEBARMENU_MPAGE_Selecteditemtarget", GXutil.rtrim( Sidebarmenu_Selecteditemtarget));
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "SIDEBARMENU_MPAGE_Iscollapsed", GXutil.booltostr( Sidebarmenu_Iscollapsed));
   }
   ...
   public void renderHtmlCloseForm012( )
   {
      ...
      httpContext.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?20235231552214", false, true);
   ...
   public void wb010( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( ! ShowMPWhenPopUp( ) && httpContext.isPopUpObject( ) )
         {
            ...
            com.kbbaru.GxWebStd.classAttribute( httpContext, "gx-content-placeholder");
         ...
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, divMaintable_Internalname, 1, 0, "px", 0, "px", "MainContainer", "left", "top", "", "", "div");
         /* Div Control */
         ...
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, divHeader_Internalname, 1, 0, "px", 0, "px", "HeaderContainer ContainerFluid", "left", "top", " "+"data-gx-flex"+" ", "align-items:center;", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 24, "px", "", "left", "top", " "+"classref"+" ", "align-self:center;", "div");
         ...
         com.kbbaru.GxWebStd.gx_bitmap( httpContext, imgImage2_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_General\\UI\\MasterUnanimoSidebar.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", " "+"classref"+" ", "min-height:20;", "div");
         /* Static images/pictures */
         ...
         com.kbbaru.GxWebStd.gx_bitmap( httpContext, imgImage1_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_General\\UI\\MasterUnanimoSidebar.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "Center", "top", " "+"classref"+" ", "flex-grow:1;min-height:20;", "div");
         /* Text block */
         com.kbbaru.GxWebStd.gx_label_ctrl( httpContext, lblApplicationheader_Internalname, "Application Name", "", "", lblApplicationheader_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "header__title", 0, "", 1, 1, 0, (short)(0), "HLP_General\\UI\\MasterUnanimoSidebar.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "Center", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-2", "left", "top", "", "", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, divTablesidebarcontainer_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, divContent_Internalname, 1, 0, "px", 0, "px", divContent_Class, "left", "top", "", "", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
   ...
   public void strup010( )
   {
      ...
      {
         /* Read saved SDTs. */
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( "vSIDEBARITEMS_MPAGE"), AV5sidebarItems);
         /* Read saved values. */
   ...
   protected void e11012( )
   {
      ...
      new com.kbbaru.general.ui.sidebaritemsdp(remoteHandle, context).execute( GXv_objcol_SdtSidebarItems_SidebarItem2) ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?20235231552247", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?20235231552247", false, true);
      httpContext.AddJavascriptSource("Unanimo_chameleon/chameleon.js", "", false, true);
      httpContext.AddJavascriptSource("UserControls/GeneXusUnanimo.SidebarRender.js", "", false, true);
