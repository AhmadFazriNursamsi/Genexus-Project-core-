...
public final  class gx0020_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.kbbaru.gx0020", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8pCategoryId,4,0))}, new String[] {"pCategoryId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "GXH_vCCATEGORYID", GXutil.ltrim( localUtil.ntoc( AV6cCategoryId, (byte)(4), (byte)(0), ".", "")));
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "GXH_vCCATEGORYNAME", AV7cCategoryName);
      /* Send saved values. */
      send_integrity_footer_hashes( ) ;
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_34", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_34, (byte)(8), (byte)(0), ".", "")));
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "vPCATEGORYID", GXutil.ltrim( localUtil.ntoc( AV8pCategoryId, (byte)(4), (byte)(0), ".", "")));
      ...
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "CATEGORYNAMEFILTERCONTAINER_Class", GXutil.rtrim( divCategorynamefiltercontainer_Class));
   }
   ...
   {
      return formatLink("com.kbbaru.gx0020", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8pCategoryId,4,0))}, new String[] {"pCategoryId"})  ;
   }
   ...
   public void wb110( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kbbaru.GxWebStd.gx_label_ctrl( httpContext, lblLblcategoryidfilter_Internalname, "Category Id", "", "", lblLblcategoryidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11111_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0020.htm");
         ...
         com.kbbaru.GxWebStd.gx_single_line_edit( httpContext, edtavCcategoryid_Internalname, GXutil.ltrim( localUtil.ntoc( AV6cCategoryId, (byte)(4), (byte)(0), ".", "")), GXutil.ltrim( ((edtavCcategoryid_Enabled!=0) ? localUtil.format( DecimalUtil.doubleToDec(AV6cCategoryId), "ZZZ9") : localUtil.format( DecimalUtil.doubleToDec(AV6cCategoryId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategoryid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategoryid_Visible, edtavCcategoryid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_Gx0020.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, divCategorynamefiltercontainer_Internalname, 1, 0, "px", 0, "px", divCategorynamefiltercontainer_Class, "left", "top", "", "", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kbbaru.GxWebStd.gx_label_ctrl( httpContext, lblLblcategorynamefilter_Internalname, "Category Name", "", "", lblLblcategorynamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12111_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0020.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.kbbaru.GxWebStd.gx_label_element( httpContext, edtavCcategoryname_Internalname, "Category Name", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 26,'',false,'" + sGXsfl_34_idx + "',0)\"" ;
         com.kbbaru.GxWebStd.gx_single_line_edit( httpContext, edtavCcategoryname_Internalname, AV7cCategoryName, GXutil.rtrim( localUtil.format( AV7cCategoryName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategoryname_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategoryname_Visible, edtavCcategoryname_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_Gx0020.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.kbbaru.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e13111_client"+"'", TempTags, "", 2, "HLP_Gx0020.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 34 )
      {
         ...
         StyleString = "" ;
         com.kbbaru.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0020.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   {
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "gxhash_CATEGORYID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A3CategoryId), "ZZZ9")));
   ...
   public void rf112( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV7cCategoryName = GXutil.concat( GXutil.rtrim( AV7cCategoryName), "%", "") ;
         /* Using cursor H00112 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV6cCategoryId), lV7cCategoryName, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_34_idx = 1 ;
         sGXsfl_34_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_34_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_342( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subgrid1_fnc_recordsperpage( ) ) ) )
         {
            A4CategoryName = H00112_A4CategoryName[0] ;
            A3CategoryId = H00112_A3CategoryId[0] ;
            /* Execute user event: Load */
            e15112 ();
   ...
   {
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, "gxhash_CATEGORYID"+"_"+sGXsfl_34_idx, getSecureSignedToken( sGXsfl_34_idx, localUtil.format( DecimalUtil.doubleToDec(A3CategoryId), "ZZZ9")));
   }
   ...
   public void e14112( )
   {
      /* Start Routine */
      returnInSub = false ;
      Form.setCaption( GXutil.format( "Selection List %1", "Category", "", "", "", "", "", "", "", "") );
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20235231553258", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0020.js", "?20235231553258", false, true);
   ...
   public void sendrow_342( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subgrid1_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A3CategoryId, (byte)(4), (byte)(0), ".", "")))+"'"+"]);" ;
         ...
         edtCategoryName_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A3CategoryId, (byte)(4), (byte)(0), ".", "")))+"'"+"]);" ;
   ...
   public void startgridcontrol34( )
   {
      ...
      else
      {
         ...
         Grid1Container.AddColumnProperties(Grid1Column);
         Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         Grid1Column.AddObjectProperty("Value", WebUtils.htmlEncode( A4CategoryName));
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("LBLCATEGORYIDFILTER.CLICK","{handler:'e11111',iparms:[{av:'divCategoryidfiltercontainer_Class',ctrl:'CATEGORYIDFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("LBLCATEGORYNAMEFILTER.CLICK","{handler:'e12111',iparms:[{av:'divCategorynamefiltercontainer_Class',ctrl:'CATEGORYNAMEFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("ENTER","{handler:'e16112',iparms:[{av:'A3CategoryId',fld:'CATEGORYID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV7cCategoryName = "" ;
      H00112_A4CategoryName = new String[] {""} ;
      H00112_A3CategoryId = new short[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.kbbaru.gx0020__default(),
         new Object[] {
             new Object[] {
            H00112_A4CategoryName, H00112_A3CategoryId
            }
            , new Object[] {
   ...
   private String[] H00112_A4CategoryName ;
   private short[] H00112_A3CategoryId ;
...
final  class gx0020__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00112(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).shortValue() );
            case 1 :
                  return conditional_H00113(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).shortValue() );
      }
