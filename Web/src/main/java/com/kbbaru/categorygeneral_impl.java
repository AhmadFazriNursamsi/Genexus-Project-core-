...
public final  class categorygeneral_impl extends GXWebComponent
{
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(A3CategoryId)});
               componentstart();
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.kbbaru.categorygeneral", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A3CategoryId,4,0))}, new String[] {"CategoryId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOA3CategoryId", GXutil.ltrim( localUtil.ntoc( wcpOA3CategoryId, (byte)(4), (byte)(0), ".", "")));
   }
   ...
   public void wb1P0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.kbbaru.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.kbbaru.categorygeneral");
         }
         ...
         StyleString = "" ;
         com.kbbaru.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e111p1_client"+"'", TempTags, "", 2, "HLP_CategoryGeneral.htm");
         ...
         StyleString = "" ;
         com.kbbaru.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e121p1_client"+"'", TempTags, "", 2, "HLP_CategoryGeneral.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.kbbaru.GxWebStd.gx_label_element( httpContext, edtCategoryName_Internalname, "Name", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
         /* Div Control */
         com.kbbaru.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         com.kbbaru.GxWebStd.gx_single_line_edit( httpContext, edtCategoryName_Internalname, A4CategoryName, GXutil.rtrim( localUtil.format( A4CategoryName, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCategoryName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtCategoryName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "Name", "left", true, "", "HLP_CategoryGeneral.htm");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kbbaru.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void rf1P2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A4CategoryName = H001P2_A4CategoryName[0] ;
   ...
   public void strup1P0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         wcpOA3CategoryId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA3CategoryId"), ".", ",")) ;
   ...
   {
      A3CategoryId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "A3CategoryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CategoryId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlA3CategoryId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      {
         A3CategoryId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A3CategoryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CategoryId), 4, 0));
      }
      wcpOA3CategoryId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA3CategoryId"), ".", ",")) ;
      if ( ! GetJustCreated( ) && ( ( A3CategoryId != wcpOA3CategoryId ) ) )
      {
         setjustcreated();
      }
      wcpOA3CategoryId = A3CategoryId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlA3CategoryId = httpContext.cgiGet( sPrefix+"A3CategoryId_CTRL") ;
      if ( GXutil.len( sCtrlA3CategoryId) > 0 )
      {
         A3CategoryId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlA3CategoryId), ".", ",")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A3CategoryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CategoryId), 4, 0));
      }
      else
      {
         A3CategoryId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"A3CategoryId_PARM"), ".", ",")) ;
      }
   }
   ...
   {
      com.kbbaru.GxWebStd.gx_hidden_field( httpContext, sPrefix+"A3CategoryId_PARM", GXutil.ltrim( localUtil.ntoc( A3CategoryId, (byte)(4), (byte)(0), ".", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlA3CategoryId)) > 0 )
      {
         com.kbbaru.GxWebStd.gx_hidden_field( httpContext, sPrefix+"A3CategoryId_CTRL", GXutil.rtrim( sCtrlA3CategoryId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202352610413645", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("categorygeneral.js", "?202352610413645", false, true);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'A3CategoryId',fld:'CATEGORYID',pic:'ZZZ9'}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("'DOUPDATE'","{handler:'e111P1',iparms:[{av:'A3CategoryId',fld:'CATEGORYID',pic:'ZZZ9'}]");
      setEventMetadata("'DOUPDATE'",",oparms:[]}");
      setEventMetadata("'DODELETE'","{handler:'e121P1',iparms:[{av:'A3CategoryId',fld:'CATEGORYID',pic:'ZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      AV13Pgmname = "" ;
      scmdbuf = "" ;
      H001P2_A3CategoryId = new short[1] ;
      H001P2_A4CategoryName = new String[] {""} ;
      ...
      sCtrlA3CategoryId = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.kbbaru.categorygeneral__default(),
         new Object[] {
             new Object[] {
            H001P2_A3CategoryId, H001P2_A4CategoryName
            }
         }
      );
      AV13Pgmname = "CategoryGeneral" ;
   ...
   private short wcpOA3CategoryId ;
   ...
   private String sCtrlA3CategoryId ;
   ...
   private short[] H001P2_A3CategoryId ;
   private String[] H001P2_A4CategoryName ;
...
final  class categorygeneral__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H001P2", "SELECT CategoryId, CategoryName FROM Category WHERE CategoryId = ? ORDER BY CategoryId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
