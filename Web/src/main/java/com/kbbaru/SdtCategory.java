...
public final  class SdtCategory extends GxSilentTrnSdt
{
   ...
   {
      super( remoteHandle, context, "SdtCategory");
   ...
   public void Load( short AV3CategoryId )
   {
      IGxSilentTrn obj;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {Short.valueOf(AV3CategoryId)});
   }
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("CategoryName", gxTv_SdtCategory_Categoryname);
      if ( GXutil.strcmp(sNameSpace, "KBBaru") != 0 )
      {
         oWriter.writeAttribute("xmlns", "KBBaru");
      }
      if ( sIncludeState )
      {
         oWriter.writeElement("Mode", gxTv_SdtCategory_Mode);
         if ( GXutil.strcmp(sNameSpace, "KBBaru") != 0 )
         {
            oWriter.writeAttribute("xmlns", "KBBaru");
         }
         ...
         oWriter.writeElement("CategoryName_Z", gxTv_SdtCategory_Categoryname_Z);
         if ( GXutil.strcmp(sNameSpace, "KBBaru") != 0 )
         {
            oWriter.writeAttribute("xmlns", "KBBaru");
         }
   ...
   public void updateDirties( com.kbbaru.SdtCategory sdt )
   {
   ...
   {
      initialize( ) ;
      com.kbbaru.category_bc obj;
      obj = new com.kbbaru.category_bc( remoteHandle, context) ;
      obj.initialize();
   ...
   public com.kbbaru.SdtCategory Clone( )
   {
      com.kbbaru.SdtCategory sdt;
      com.kbbaru.category_bc obj;
      sdt = (com.kbbaru.SdtCategory)(clone()) ;
      obj = (com.kbbaru.category_bc)(sdt.getTransaction()) ;
      obj.SetSDT(sdt, (byte)(0));
      return sdt ;
   }

   public void setStruct( com.kbbaru.StructSdtCategory struct )
   {
      if ( struct != null )
      {
   ...
   public com.kbbaru.StructSdtCategory getStruct( )
   {
      com.kbbaru.StructSdtCategory struct = new com.kbbaru.StructSdtCategory ();
